...
---
**Результат предсказание на видео**
...
├── output_folder/              # Кадры извлеченные из видео / файлы аннотаций в формате .json (для X-AnyLabeling)
...
Проект ZebraTest представляет собой систему компьютерного зрения для обнаружения и классификации объектов с использованием моделей YOLO. Проект включает в себя полный цикл работы с данными:
