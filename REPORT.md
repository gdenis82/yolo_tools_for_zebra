...
- Разработать скрипт для автоматического сравнения показателей метрик обучения и метрик валидаций модели для быстрого принятия решения. Или использовать сервисы "Comet ML", "ClearML". 
